...
constexpr auto qt_meta_stringdata_CLASSRegisterENDCLASS = QtMocHelpers::stringData(
    "Register",
    "signal_registrationCompleted",
    "",
    "on_send_register_button_clicked"
);
...
Q_CONSTINIT const QMetaObject Register::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSRegisterENDCLASS_t,
        ...
        // method 'signal_registrationCompleted'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_send_register_button_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signal_registrationCompleted(); break;
        case 1: _t->on_send_register_button_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Register::signal_registrationCompleted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Register::signal_registrationCompleted()
{
