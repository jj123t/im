...
Q_CONSTINIT const QMetaObject Login::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginENDCLASS_t,
        ...
        // method 'signal_registerRequested'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'signal_showLauncher'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void Login::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signal_registerRequested(); break;
        case 1: _t->signal_showLauncher(); break;
        ...
        {
            using _t = void (Login::*)();
            if (_t _q_method = &Login::signal_registerRequested; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Login::*)();
            if (_t _q_method = &Login::signal_showLauncher; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Login::signal_registerRequested()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Login::signal_showLauncher()
{
